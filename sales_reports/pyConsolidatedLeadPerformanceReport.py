...
def _apply_metric_header_line(tab, leads):
    ...
    _SEP = "     |     "
    fresh_nonref = sum(1 for a in leads if a.get("_is_new") and not is_referral(a))
    fresh_rel = sum(1 for a in leads if a.get("_is_new") and not is_referral(a)
                    and yes(a.get(C_RELEV)))
    ...
    segs = [
        ("Fresh:  ", CLR_SUB_FG, HEX["SUB_FG"]),
        (str(fresh_nonref), CLR_SUB_FG, HEX["SUB_FG"]),
        (_SEP + "Fresh-Relevant:  ", CLR_SUB_FG, HEX["SUB_FG"]),
        (str(fresh_rel), CLR_SUB_FG, HEX["SUB_FG"]),
        (_SEP + "Fresh-Relevant:  ", CLR_SUB_FG, HEX["SUB_FG"]),
        (f"{rel_pct:.1f}%", CLR_SUB_FG, HEX["SUB_FG"]),
        (_SEP + "Lead Completion %:  ", CLR_SUB_FG, HEX["SUB_FG"]),
